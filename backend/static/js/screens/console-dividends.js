...
// Store full objects for easy editing without re-fetching
...
function handleEditSelectedEntry() {
    ...
    editDividendEntry(entry.id, entry.account_id, entry.dividend_date, entry.amount, entry.tax, entry.memo);
}
