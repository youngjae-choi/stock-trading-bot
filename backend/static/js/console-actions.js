  ...
  function dispatchConsoleClickAction(element) {
    ...
    var actionMap = {
      ...
      setMissedRange: function() { return setMissedRange(element.dataset.filter); },
      loadFalsePositive: function() { return loadFalsePositive(); },
      searchFalsePositive: function() { return searchFalsePositive(); },
      generateFalsePositive: function() { return generateFalsePositive(); },
      setFpRange: function() { return setFpRange(element.dataset.filter); },
      loadPlanFunnel: function() { return loadPlanFunnel(); },
      ...
      loadReviewByDate: function() { return loadReviewByDate(); },
