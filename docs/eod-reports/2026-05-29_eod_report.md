# EOD 검증 리포트 — 2026-05-29

- 생성: 2026-05-29T18:30:01.412106+09:00
- 거래일: YES (weekday + skip_today=false)
- 결과: PASS 5 / WARN 12 / FAIL 7 / SKIP 0 / INFO 5
...
- **결과**: active_total=203
- **증거**:
  - `{'scope': 'S3_UNIVERSE_FILTER', 'cnt': 74}`
  - `{'scope': 'S4_HYBRID_SCREENING', 'cnt': 104}`
  - `{'scope': 'S5_DAILY_PLAN', 'cnt': 25}`
...
- **결과**: missed=316, buys=7, ratio=45.1
